    ...
    <div class="vd_content-wrapper">
        ...
        <div class="vd_content clearfix">
          <div class="vd_head-section clearfix">
            <div class="vd_panel-header">
              <ul class="breadcrumb">
                ...
                <li class="active">Upfront Request</li>
              </ul>
              <div
          ...
          <div class="vd_title-section clearfix">
            <div class="vd_panel-header">
              <h1>
                <span class="append-icon icon-arrow-up2"></span> Upfront Request
              </h1>
            </div>
          </div>
          ...
          <div class="dashboardPanels clearfix">
            <div class="col-md-4 col-sm-12 text-center company">
              <div class="vd_status-widget widget dashboardPanel">
                <a class="panel-body vd_blue pd-5" href="#">
                  <div class="clearfix">
                    <div class="menu-text clearfix">New <br />Request</div>
            ...
            <div class="col-md-4 col-sm-12 text-center company">
              <div class="vd_status-widget widget dashboardPanel">
                <a class="panel-body vd_blue pd-5" href="#">
                  <div class="clearfix">
                    <div class="menu-text clearfix">Upfront <br />Done</div>
            ...
            <div class="col-md-4 col-sm-12 text-center company">
              <div class="vd_status-widget widget dashboardPanel">
                <a class="panel-body vd_blue pd-5" href="#">
                  <div class="clearfix">
                    <div class="menu-text clearfix">Denied <br />Upfronts</div>
                ...
                <div id="category1" class="active tab-pane   in">
                  <div class="tabs widget">
                    <ul class="nav nav-tabs widget">
                      <li class="active">
                        <a data-toggle="tab" href="#upfrontDone">
                          Upfront done
                      ...
                      <li>
                        <a data-toggle="tab" href="#upfrontDenied">
                          Upfront Denied
                          <span class="menu-active"
                            ><i class="fa fa-caret-up"></i
                          ></span>
                                  ...
                                  <table class="table table-hover">
                                    <thead>
                                      <tr>
                                        ...
                                        <th class="text-center">Upfront ID</th>
                                        ...
                                        <th class="text-center">Ready Paid</th>
                                      ...
                                      <tr class="text-center">
                                        ...
                                        <td class="menu-action">
                                          <a
                                            ...
                                            ><span
                                              class="label label-default vd_bg-green"
                                              >Accepted</span
                                            ></a
                                          >
                                        </td>
                                      ...
                                      <tr class="text-center">
                                        ...
                                        <td class="menu-action">
                                          <a
                                            ...
                                            href="javascript:void(0);"
                                            ><span
                                              class="label label-default vd_bg-red"
                                              >Denied</span
                                            ></a
                                          >
                                        </td>
