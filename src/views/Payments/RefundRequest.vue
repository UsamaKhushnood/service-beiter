    ...
    <div class="vd_content-wrapper">
        ...
        <div class="vd_content clearfix">
          ...
          <div class="vd_title-section clearfix">
            <div class="vd_panel-header">
              <h1>
                <span class="append-icon icon-cycle"></span> Refund Request
              </h1>
            </div>
          </div>
                ...
                <div id="category1" class="active tab-pane fade in">
                  <div class="tabs widget">
                    <ul class="nav nav-tabs widget">
                      ...
                      <li>
                        <a data-toggle="tab" href="#clientRequest">
                    ...
                    <div class="tab-content">
                                  ...
                                  <table class="table table-hover">
                                    <thead>
                                      <tr>
                                        ...
                                        <th class="text-center">Refund ID</th>
                      ...
                      <div id="clientRequest" class="tab-pane fade">
                        <div class="pd-20">
                          <div class="row">
                            <div class="col-md-12">
                              <div class="panel widget">
