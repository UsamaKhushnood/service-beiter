    ...
    <div class="vd_content-wrapper">
        ...
        <div class="vd_content clearfix">
          ...
          <div class="vd_title-section clearfix">
            <div class="vd_panel-header">
              <h1>
                <span class="append-icon icon-drawer"></span> All Services
              </h1>
            </div>
          </div>
          ...
          <div class="dashboardPanels clearfix">
            <div class="col-md-3 col-sm-12 text-center company">
              <div class="vd_status-widget widget dashboardPanel">
                <a class="panel-body vd_blue pd-5" href="#">
                  <div class="clearfix">
                    <div class="menu-text clearfix">New <br />Services</div>
            ...
            <div class="col-md-3 col-sm-12 text-center company">
              <div class="vd_status-widget widget dashboardPanel">
                <a class="panel-body vd_blue pd-5" href="#">
                  <div class="clearfix">
                    <div class="menu-text clearfix">Services <br />on Hold</div>
            ...
            <div class="col-md-3 col-sm-12 text-center company">
              <div class="vd_status-widget widget dashboardPanel">
                <a class="panel-body vd_blue pd-5" href="#">
                  <div class="clearfix">
                    <div class="menu-text clearfix">Denied <br />Services</div>
