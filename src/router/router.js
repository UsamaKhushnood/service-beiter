...
const routes = [{
    ...
    { path: '/NewRequest', name: "NeqRequest", component: NewRequest },
    ...
    { path: '/UpfrontRequest', name: "UpfrontRequest", component: UpfrontRequest },
    { path: '/RefundRequest', name: "RefundRequest", component: RefundRequest },
    { path: '/ReleaseRequest', name: "ReleaseRequest", component: ReleaseRequest },
    { path: '/EscrowAccounts', name: "EscrowAccounts", component: EscrowAccounts },
    ...
    { path: '/AccountUpgradeClient', name: "AccountUpgradeClient", component: AccountUpgradeClient },
    { path: '/AddCountry', name: "AddCountry", component: AddCountry },
    { path: '/Administrator', name: "Administrator", component: Administrator },
    { path: '/BidsAmountClient', name: "BidsAmountClient", component: BidsAmountClient },
    { path: '/CompanyCharacter', name: "CompanyCharacter", component: CompanyCharacter },
    { path: '/CompanySkill', name: "CompanySkill", component: CompanySkill },
    { path: '/CompanyType', name: "CompanyType", component: CompanyType },
    { path: '/ManageLanguages', name: "ManageLanguages", component: ManageLanguages },
    { path: '/Policy', name: "Policy", component: Policy },
    { path: '/Reasons', name: "Reasons", component: Reasons },
    { path: '/ServiceComission', name: "ServiceComission", component: ServiceComission },
